...
//  PeevedPenguins
//
//  Created by Danny Peng on 6/27/16.
...
class GameScene: SKScene,SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        let catapultPinJoint = SKPhysicsJointPin.jointWithBodyA(catapult.physicsBody!, bodyB: catapultArm.physicsBody!, anchor: CGPoint(x:275 ,y:113))
  ...
  /*  override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        /* Impulse vector */
        let launchDirection = CGVector(dx: 25, dy: 0)
